...
%% This function is to return the indices of the neighbors of location i, j, k
% INPUT:
%     ind：the id of focused regions
%     YourMatrix:3D (TODO: 2D) matrix indicating the similarity of voxels
%     connect: connection for edges in the graph(4,6,8,10,18,26)
% OUTPUT:
%     nei_mat:neighbors of focused regions
